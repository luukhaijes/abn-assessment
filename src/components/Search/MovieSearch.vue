<template>
  <Teleport to="body">
    <div class="bg-opacity-30 fixed inset-0 z-10 overflow-y-auto bg-black">
      <div
      ...
      <div class="flex items-start justify-center text-center md:py-12">
        <div
          class="w-full overflow-hidden rounded-md bg-white text-left shadow-xl md:w-1/2 lg:w-1/3"
        >
...
import { useShowSearch } from "@/composables/use-show-search";
